...
const menuCenterMap: Map<string, (children: JSX.Element) => JSX.Element> = new Map([
  [
    'message center',
    (children) => (
      <a>
...
const musicServerMap: Map<string, (children: JSX.Element) => JSX.Element> = new Map([
  [
    'yunchunyoupiao',
    (children) => (
      <a>
...
const UserMessages: NextComponentType = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* music server */}
      <div className="mt-4">
        <Menu contentMap={musicServerMap} />
      </div>
    </div>
  )
}
